...
void Actor::draw()
{
	...
	{
	case ActorType_Guard:
		engine.renderer.queueSprite((SpriteFrame*)&Data_guardSprite_frames[frame], (uint8_t *)&Data_guardSprite_data_2bpp[0], x, z);
		break;
	case ActorType_Dog:
		engine.renderer.queueSprite((SpriteFrame*)&Data_dogSprite_frames[frame], (uint8_t *)&Data_dogSprite_data_2bpp[0], x, z);
		break;
	case ActorType_SS:
		engine.renderer.queueSprite((SpriteFrame*)&Data_ssSprite_frames[frame], (uint8_t *)&Data_ssSprite_data_2bpp[0], x, z);
		break;
	case ActorType_Boss:
		engine.renderer.queueSprite((SpriteFrame*)&Data_bossSprite_frames[frame], (uint8_t *)&Data_bossSprite_data_2bpp[0], x, z);
		break;
	}
}
